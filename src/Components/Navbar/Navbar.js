               ...
               <ul className="nav">
                    <li className="nav-item">
                         <Link to="/" className="nav-link">
                              <svg width="2em" height="2em" viewBox="0 0 16 16" className="icons bi bi-house-door" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li className="nav-item">
                         <Link to="/cart" className="nav-link">
                              ...
                              <svg width="2em" height="2em" viewBox="0 0 16 16" className="icons bi bi-cart2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li className="nav-item">
                         <Link to="/profile" className="nav-link">
                              <img src={currentUser.photoURL} alt="user" className="avatar icons"/>
                         </Link>
                    </li>
               </ul>
          </div>
