               ...
               <ul className="nav">
                    <li className="nav-item">
                         <Link to="/" className="nav-link">
                              <svg width="1.75em" height="1.75em" viewBox="0 0 16 16" className="icons bi bi-house-door" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li className="nav-item">
                         <Link to="/profile" className="nav-link">
                              <svg width="1.75em" height="1.75em" viewBox="0 0 16 16" className="icons bi bi-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
